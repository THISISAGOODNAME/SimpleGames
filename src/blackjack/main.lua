function love.load()
    ...
    function isMouseInButton(button)        
        return love.mouse.getX() >= button.x and love.mouse.getX() < button.x + button.width and love.mouse.getY() >= button.y and love.mouse.getY() < button.y + button.height
    end
end
...
function love.draw()
    ...
    for cardIndex, card in ipairs(dealerHand) do
        ...
        if not roundOver and cardIndex == 1 then
            ...
            drawCard(card, (cardIndex - 1) * cardSpaceing + marginX, dealerMarginY)
        end
    end
      
    for cardIndex, card in ipairs(playerHand) do
        drawCard(card, (cardIndex - 1) * cardSpaceing + marginX, 140)
    end
    ...
    love.graphics.print("Totals: "..getTotal(playerHand), marginX, 120)
